...
def get_datasets(cfg):
    ...
    visual_feat_path = os.path.join(rootpath, collection, 'FeatureData', 'new_clip_vit_32_%s_vid_features.hdf5' % collection)
    ...
    val_video_dataset = VisDataSet4PRVR(visual_feat_path, video2frames, cfg, video_ids=val_video_ids_list)
    ...
    test_text_feat_path = os.path.join(rootpath, collection, 'TextData', 'clip_ViT_B_32_%s_query_feat.hdf5' % collection)
    # Load visual features
    test_visual_feat_path = os.path.join(rootpath, collection, 'FeatureData', 'new_clip_vit_32_%s_vid_features.hdf5' % collection)
    ...
    test_vid_dataset = VisDataSet4PRVR(test_visual_feat_path, test_video2frames, cfg, video_ids=test_video_ids_list)
